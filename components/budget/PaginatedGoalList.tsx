...
interface PaginatedGoalListProps {
    goals: Goal[];
...
const PaginatedGoalList: React.FC<PaginatedGoalListProps> = ({
    ...
    const paginatedGoals = goals.slice(startIndex, startIndex + itemsPerPage);
...
export default PaginatedGoalList;