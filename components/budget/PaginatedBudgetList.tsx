...
interface PaginatedBudgetListProps {
    budgets: Budget[];
    onEdit: (budget: Budget) => void;
    onDelete: (budget: Budget) => void;
    onCreate: () => void;
    loadingBudgetId?: string | null;
}

const PaginatedBudgetList: React.FC<PaginatedBudgetListProps> = ({
...
export default PaginatedBudgetList;